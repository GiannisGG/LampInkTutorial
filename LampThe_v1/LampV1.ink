...
it does NOT include the following Ink features:
...
A stitch is a basically a... sub-knot. A knot's section.
*/
...
/*
The only thing you can do regardless of var values
...
we must use the "knotName.stitchName" syntax.
*/
	->Treasury.routineReaction
...
=== takeLamp ===
/*
This is a silly fight sequence between the PC and the lamp.
...
//  After all of the above is done, we proceed
//  to the next gather:
...
/*
The {examined} condition below is redundant,
since there is no way we reach this point
without having examined the lamp before
the previous gather. Still, it's good practice
to rely on such "defensive logic," since not always
can we deduct conclusions as to what the player
must have done. Better safe than sorry.
*/
...
//  All of the above actions lead to the same result/gather:
